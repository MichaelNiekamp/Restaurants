...
android {
    ...
    // Java/Kotlin toolchains for AGP 8.x + Kotlin 2.x
    compileOptions {
    ...
    // No composeOptions needed when using org.jetbrains.kotlin.plugin.compose
...
// Room schema export location (useful for migration tests)
ksp {
